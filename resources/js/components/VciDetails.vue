    ...
    <div class="contentbar" style="padding:8px 30px 30px 30px !important;">
        <div class="card m-b-30">
          ...
          <div class="card-body">
            ...
            <div class="card" v-if="$role.isPermission('all_products_list')">
              <!-- /.card-header -->
...
<tr v-for="(vcidetail,index) in vcidetails.data" :key="vcidetail.id">
                                       ...
                                       <td>{{fromData+index}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a v-if="vcidetail.sold_status == '0'" href="#" class="btn btn-rounded btn-warning-rgba" @click="mapping(vcidetail)">
        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog zoomIn  animated" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Add Products</h5>
                    <h5 class="modal-title" v-show="editmode">Update Products</h5>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                  ...
                  axios.get('/api/vcidetail?page=' + page).then(({ data }) => (this.vcidetails = data.data,this.fromData = data.data.from));
            ...
            loadVciDetail(){
                if(this.$gate.isAdmin()){
                    axios.get("/api/vcidetail").then(({ data }) => (this.vcidetails = data.data,this.fromData = data.data.from));
                }
            },
            loadUser(){
