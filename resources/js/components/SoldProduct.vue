      ...
      <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        <h4 class="page-title">Sold Products
    ...
    <div class="contentbar" style="padding:8px 30px 30px 30px !important;">
        <div class="card m-b-30">
          ...
          <div class="card-body">
            ...
            <div class="card" v-if="$role.isPermission('sold_products_list')">
              <!-- /.card-header -->
...
<tr v-for="(vcidetail,index) in vcidetails.data" :key="vcidetail.id">
                                       ...
                                       <td>{{fromData+index}}</td>
                                        ...
                                        <td >{{vcidetail.customer_name}}</td>
                                        <td >{{vcidetail.customer_mobile}}</td>
                                        <td >{{vcidetail.technician_name}}</td>
                                        <td >{{vcidetail.start_date}}</td>
                                        <td >{{vcidetail.end_date}}</td>
                                        <td v-if="vcidetail.subscriptionstatus && vcidetail.subscriptionstatus == '1'">
                                            <span  class="badge badge-pill badge-success" style="padding: 0.50em .8em;">Active</span>
                                        </td>
                                        <td v-else-if="vcidetail.subscriptionstatus && vcidetail.subscriptionstatus == '0'">
                                            <span class="badge badge-pill badge-danger" style="padding: 0.50em .8em;">Inactive</span>
                                        </td>
                                        <td v-else>-</td>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                  ...
                  axios.get('/api/soldProduct?page=' + page).then(({ data }) => (this.vcidetails = data.data,this.fromData = data.data.from));
            ...
            loadVciDetail(){
                if(this.$gate.isAdmin()){
                    axios.get("/api/soldProduct").then(({ data }) => (this.vcidetails = data.data,this.fromData = data.data.from));
                }
            },
            loadUser(){
